...
function Sidebar({onNew,projects=[],onOpen,onSignOut,session}) {
  ...
  if(view==="codex")return(<div style={{display:"flex",height:"100vh",width:"100%",background:"#050816",color:"#E8EEF8"}}><div style={{width:240,borderRight:"1px solid rgba(255,255,255,.08)",padding:16,display:"flex",flexDirection:"column",gap:10,background:"#070B1A"}}><div style={{fontSize:18,fontWeight:700,color:"#00E5FF"}}>? CODEX</div><button style={{padding:10,borderRadius:8,background:"rgba(255,255,255,.04)",border:"1px solid rgba(255,255,255,.08)",color:"#E8EEF8"}}>Gmail</button><button style={{padding:10,borderRadius:8,background:"rgba(255,255,255,.04)",border:"1px solid rgba(255,255,255,.08)",color:"#E8EEF8"}}>Slack</button><button style={{padding:10,borderRadius:8,background:"rgba(255,255,255,.04)",border:"1px solid rgba(255,255,255,.08)",color:"#E8EEF8"}}>Drive</button><button style={{padding:10,borderRadius:8,background:"rgba(255,255,255,.04)",border:"1px solid rgba(255,255,255,.08)",color:"#E8EEF8"}}>WhatsApp</button><button style={{padding:10,borderRadius:8,background:"rgba(255,255,255,.04)",border:"1px solid rgba(255,255,255,.08)",color:"#E8EEF8"}}>Stripe</button></div><div style={{flex:1,display:"flex",flexDirection:"column"}}><div style={{padding:18,borderBottom:"1px solid rgba(255,255,255,.06)",display:"flex",alignItems:"center",gap:12}}><input placeholder="Decime qu� quer�s automatizar..." style={{flex:1,padding:14,borderRadius:12,background:"rgba(255,255,255,.05)",border:"1px solid rgba(255,255,255,.08)",color:"#E8EEF8",outline:"none"}}/><button style={{padding:"12px 18px",borderRadius:10,background:"rgba(0,229,255,.14)",border:"1px solid rgba(0,229,255,.25)",color:"#00E5FF"}}>Ejecutar</button></div><div style={{flex:1,display:"flex"}}><div style={{flex:1,display:"flex",alignItems:"center",justifyContent:"center",fontSize:18,color:"#6a7090"}}>Canvas operativo React Flow</div><div style={{width:320,borderLeft:"1px solid rgba(255,255,255,.08)",padding:18,display:"flex",flexDirection:"column",gap:10,background:"#070B1A"}}><div style={{fontSize:16,fontWeight:700,color:"#00E5FF"}}>NEURA OPERATOR</div><div>[?] Sistema operativo iniciado</div><div>[�] Esperando automatizaci�n</div><div>[�] Gmail disponible</div><div>[�] Slack disponible</div><div>[�] Drive disponible</div><div>[�] Modo pr�ctica listo</div></div></div></div></div>);if(view==="memory")return(<div style={{width:SIDEBAR_W,flexShrink:0,display:"flex",flexDirection:"column",background:BASE,borderRight:"1px solid rgba(0,229,255,.1)",zIndex:20}}><SBHeader label="Codex"/><div style={{padding:14,display:"flex",flexDirection:"column",gap:10}}><div style={{padding:14,borderRadius:10,background:"rgba(0,229,255,.06)",border:"1px solid rgba(0,229,255,.18)",color:"#E8EEF8",fontFamily:"DM Sans",fontSize:13}}>? CODEX<br/><span style={{color:"#6a7090",fontSize:11}}>Automatizaciones, conectores y ejecuci�n operativa.</span></div><textarea value={codexInput} onChange={e=>setCodexInput(e.target.value)} placeholder="Decime qu� quer�s automatizar..." style={{width:"100%",minHeight:90,background:"rgba(255,255,255,.04)",border:"1px solid rgba(255,255,255,.08)",borderRadius:10,padding:12,color:"#E8EEF8",fontSize:13,resize:"none",outline:"none"}}/><button onClick={runCodex} style={{padding:12,borderRadius:9,background:"rgba(0,229,255,.12)",color:"#00E5FF",border:"1px solid rgba(0,229,255,.18)",fontSize:12,cursor:"pointer"}}>Crear automatizaci�n</button>{codexFlow&&<div style={{padding:14,borderRadius:10,background:"rgba(255,255,255,.03)",border:"1px solid rgba(255,255,255,.08)",display:"flex",flexDirection:"column",gap:6,color:"#E8EEF8",fontSize:12}}><b>? AUTOMATIZACI�N DETECTADA</b><span>Trigger: {codexFlow.trigger}</span><span>Acci�n: {codexFlow.action}</span><span>Canal: {codexFlow.channel}</span><span>Asunto: {codexFlow.subject}</span><span>Cuerpo: {codexFlow.body}</span><span>Estado: {codexFlow.status}</span><button style={{marginTop:8,padding:10,borderRadius:8,background:"rgba(0,229,255,.1)",border:"1px solid rgba(0,229,255,.15)",color:"#00E5FF"}}>Simular automatizaci�n</button><button style={{padding:10,borderRadius:8,background:"rgba(255,255,255,.05)",border:"1px solid rgba(255,255,255,.08)",color:"#B8C2E8"}}>Crear en modo real</button><button style={{padding:10,borderRadius:8,background:"rgba(255,255,255,.05)",border:"1px solid rgba(255,255,255,.08)",color:"#B8C2E8"}}>Conectar Gmail</button></div>}<button style={{padding:12,borderRadius:9,background:"rgba(255,255,255,.04)",color:"#B8C2E8",border:"1px solid rgba(255,255,255,.07)",fontSize:12}}>Conectores: Gmail � Slack � Drive</button><button style={{padding:12,borderRadius:9,background:"rgba(255,255,255,.04)",color:"#B8C2E8",border:"1px solid rgba(255,255,255,.07)",fontSize:12}}>Modo pr�ctica gratis</button></div><SBFooter/></div>);if(view==="memory")return(
    <div style={{width:SIDEBAR_W,flexShrink:0,display:"flex",flexDirection:"column",background:BASE,borderRight:`1px solid ${BD}`,zIndex:20,height:"100vh"}}>

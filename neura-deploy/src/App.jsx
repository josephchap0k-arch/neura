...
function Sidebar({onNew,projects=[],onOpen,onSignOut,session}) {
  ...
  if(view==="codex")return(<div style={{width:SIDEBAR_W,flexShrink:0,display:"flex",flexDirection:"column",background:BASE,borderRight:"1px solid rgba(0,229,255,.1)",zIndex:20}}><SBHeader label="Codex"/><div style={{padding:14,display:"flex",flexDirection:"column",gap:10}}><div style={{padding:14,borderRadius:10,background:"rgba(0,229,255,.06)",border:"1px solid rgba(0,229,255,.18)",color:"#E8EEF8",fontFamily:"DM Sans",fontSize:13}}>? CODEX<br/><span style={{color:"#6a7090",fontSize:11}}>Automatizaciones, conectores y ejecuci�n operativa.</span></div><button style={{padding:12,borderRadius:9,background:"rgba(255,255,255,.04)",color:"#00E5FF",border:"1px solid rgba(0,229,255,.15)",fontSize:12}}>Crear automatizaci�n</button><button style={{padding:12,borderRadius:9,background:"rgba(255,255,255,.04)",color:"#B8C2E8",border:"1px solid rgba(255,255,255,.07)",fontSize:12}}>Conectores: Gmail � Slack � Drive</button><button style={{padding:12,borderRadius:9,background:"rgba(255,255,255,.04)",color:"#B8C2E8",border:"1px solid rgba(255,255,255,.07)",fontSize:12}}>Modo pr�ctica gratis</button></div><SBFooter/></div>);if(view==="memory")return(
    <div style={{width:SIDEBAR_W,flexShrink:0,display:"flex",flexDirection:"column",background:BASE,borderRight:`1px solid ${BD}`,zIndex:20,height:"100vh"}}>
